...
# Compliance & Security - ABDFN Cryptographic Framework

## Propósito
Garantiza la integridad y confidencialidad absoluta de los archivos procesados, asegurando que la aplicación opere bajo un modelo de "Confianza Cero" (Zero-Knowledge) respecto al servidor.
